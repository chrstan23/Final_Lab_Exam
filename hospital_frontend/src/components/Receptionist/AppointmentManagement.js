...
<div className="container">
    <h3 className="text-center mt-4 mb-4">Appointments</h3>
    ...
    <div className="row">
        ...
        <div className="col-lg-4">
            <div className="card bg-light mb-4">
                <h4 className="card-header bg-success text-white">New Appointment</h4>
                <div className="card-body">
                    ...
                    <button className="btn btn-primary btn-block" onClick={handleAddAppointment}>Schedule Appointment</button>
                </div>
            </div>
        </div>
        <div className="col-lg-8">
            <div className="card bg-light mb-4">
                <h4 className="card-header bg-info text-white">Appointment List</h4>
                <div className="card-body">
